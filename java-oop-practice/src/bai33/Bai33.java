...
//        Scanner input1 = new Scanner(new File("src/file_storing/bai33/SINHVIEN.in"));
//        Scanner input2 = new Scanner(new File("src/file_storing/bai33/DANGKY.in"));
//        Scanner input3 = new Scanner(new File("src/file_storing/bai33/TRUYVAN.in"));
        ...
        for (int i = 0; i < m; i++) {
            ...
            for (Student x : students) {
                if (x.getGender().equals(gender) && x.getSize().equals(size)) {
